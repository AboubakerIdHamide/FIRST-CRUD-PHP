...
<body>
    ...
    //  ================ Global Vriables =======================
        ...
        <form action='index.php?path=deleteStudent' method='post'>
            <tr>
        ...
        if(isset($_POST["send"])){
            ...
            if(count($res)!=0){
                ...
                foreach($res as $i){
                    ...
                    <table class='deleteTable'>
                        <form action='index.php?path=deleteStudent&codeTodelete=$code' method='post'>
                    <tr>
                        <td colspan='2'  class='msgBox hide'></td>
                    </tr>
                    <tr>
            ...
            if(isset($_POST["confirm"])){
                ...
                $res=$Etudiant->suprimerEtudiant($codeTodelete);
                $eror=false;
                $message="L`etudiant a était suprimer.";
                unset($_POST["confirm"]);
