...
<body>
    <section>
        <table>
            <form action="index.php?path=newEnp" method="post">
                <tr>
                ...
                <tr>
                    ...
                    <td><select name="codeEtudiant" required>
                        <?php
                         $eOptions=$Etudiant->afficherEtudiants();
                ...
                <tr>
                    <td><input type="submit" name="send" value="Emprunter"></td>
                </tr>
            </form>
        </table>
    </section>
    ...
    if(isset($_POST["send"])){
        ...
        if($codeE && $codeL){
            $res= $Emprunter->ajouterEmprunt($codeL, $codeE);
            if($res==true){
                $eror=false;
            ...
            $eror=true;
            $message= "L`etudiant déja enprunter ce livre !";
        }
    }
    ?>
    <script>
